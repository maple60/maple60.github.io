...
本記事は、Zhou et al. ([2025](#ref-zhou2025)) の Fig. 4 で用いられている考え方に着想を得て、principal axis regression による trait space の主軸推定と回転角の計算を学ぶためのチュートリアルです。ここで使用するデータはすべて教育目的で作成した架空データであり、Zhou et al. (2025) の元データ、図から読み取った値、または論文の結果を再現するためのデータではありません。解析手順や生態学的解釈の詳細については、原著論文を参照してください。
...
5.  固有値の比を使って、種内変異がtrait spaceの各方向にどれくらい効いているかを可視化する
...
```
       ...
       Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
      3.004   3.585   3.886   3.929   4.267   4.756 
...
```
       ...
       Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
      1.087   1.465   1.669   1.659   1.792   2.217 
...
```
       ...
       Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
      3.157   4.630   5.193   5.183   5.775   6.892 
...
```
       ...
       Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
      1.043   1.173   1.217   1.217   1.276   1.339 
...
```
       ...
       Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
      1.107   1.366   1.597   1.589   1.771   2.097 
...
```
       ...
       Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
      2.245   2.807   2.867   2.840   2.952   3.083 
