...
description: "BASIIC認証を使用したときの注意点についてのメモ"
date: "2024-06-18"
...
::: {.callout-note}
English version: [Things I Got Stuck on with BASIC Authentication](../../en/posts/2024-06-18-basic_authentification/index.qmd)
:::
