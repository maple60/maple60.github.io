...
ただし、この方法はクラウドストレージそのものに依存するのではなく、**R から通常のファイルパスとして参照できる場所にデータがあること**を前提としています。 たとえば Google Drive for desktop や OneDrive、Dropbox などを使えば、クラウド上のデータをローカルのファイルと同じように扱うことができます。
