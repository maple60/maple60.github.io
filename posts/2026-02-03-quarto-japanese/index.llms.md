...
PDF出力には、[LaTex](https://www.latex-project.org/)をインストールする必要があります。 公式で推奨されているのは[TinyTeX](https://yihui.org/tinytex/)です。
...
> **NOTE:**
>
> LaTeXがインストールされていない状態で、PDF出力を試みると、エラーが発生します。 この時、`quarto install tinytex`を実行してTexをインストールするようにメッセージが表示されます。
