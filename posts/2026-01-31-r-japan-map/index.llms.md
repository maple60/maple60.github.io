...
[`ne_countries()`](https://docs.ropensci.org/rnaturalearth/reference/ne_countries.html)関数を使って日本の地図データを取得し、[`plot()`](https://rdrr.io/r/graphics/plot.default.html)関数で描画します。
...
> **NOTE:**
>
> [`ne_countries()`](https://docs.ropensci.org/rnaturalearth/reference/ne_countries.html)関数の詳細については、公式ドキュメントを参照してください。
>
