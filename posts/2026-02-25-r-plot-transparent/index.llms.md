...
`adjustcolor()`は、既存の色を微調整するための関数です。 `alpha.f`引数を使って、透明度を指定することができます。 例えば、以下のようにして、点の色に透明度を指定することができます。
...
`rgb()`は、赤、緑、青の値を指定して色を作成する関数です。 `alpha`引数を使って、透明度を指定することができます。 例えば、以下のようにして、点の色に透明度を指定することができます。
