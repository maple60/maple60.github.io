...
> **NOTE:**
>
> Original Japanese version: [Bookdownで404エラーが出たときの原因の一つはURLエンコード](../../../posts/2024-06-19-bookdown-url/index.llms.md)
...
For example, the Japanese character `あ` is replaced by `%E3%81%82`. Because the conversion uses combinations of `%` and character codes, it is apparently also called **percent encoding**.
...
However, in the link generated by Bookdown, it had been converted to `%E3%83%9E%E3%83%83%E3%83%95%E3%82%9A`. The difference is that `プ` was encoded as a separated `フ` plus `ﾟ`, the half-voiced sound mark.
