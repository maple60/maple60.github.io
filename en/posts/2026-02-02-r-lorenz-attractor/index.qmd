---
title: "Drawing the Lorenz Attractor in R"
description: "How to solve the Lorenz equations with the deSolve package and draw the Lorenz attractor. This post also shows how to create 3D plots with scatterplot3d and plotly."
date: "2026-02-02"
...
::: {.callout-note}
Original Japanese version: [RでLorenz attractorを描く](../../../posts/2026-02-02-r-lorenz-attractor/index.qmd)
:::
...
::: {.callout-note}
## Lorenz Attractor and Lorenz Equations
...
Here, $x$, $y$, and $z$ are the state variables of the system, and $\sigma$, $\rho$, and $\beta$ are parameters.
Commonly used parameter values are as follows.
...
Use the `ode()` function to solve the Lorenz equations.
...
First, create two-dimensional plots.
Draw the x-y, x-z, and y-z planes.
...
You can also add animation by time frame.
The drawing frames are thinned to make the animation lighter.
